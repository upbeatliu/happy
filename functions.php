...
function wp_bootstrap_starter_scripts() {
    ...
    if ( get_theme_mod( 'cdn_assets_setting' ) === 'yes' ) {
        ...
        // wp_enqueue_script('clean-scriptjs', get_template_directory_uri() . '/js/min/build.min.js', array('jquery'), '', true );        
        wp_enqueue_script('clean-scriptjs', get_template_directory_uri() . '/js/main.js', array('jquery'), '', true );
    }
...
/**
 * change related products position into tabs
 */
...
$tabs['related_products'] = array(
   'title'    => __( 'Related Plans', 'woocommerce' ),
   'priority'    => 50,
